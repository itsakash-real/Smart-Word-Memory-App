...
function App() {
 ...
 // const selectedPage = 2 // zero is for welcome 1 for dashbord , 2 is for challenge
...
function handleChangePage(pageIndex) {
 ...
 useEffect(() => {
  //this callback function is rigerred on pageload
  ...
  if(localStorage.getItem('attempts')){
    ...
    let data = setAttempts(parseInt(localStorage.getItem('attempts')))
  }
...
if(localStorage.getItem('day')){
  ...
  if(d > 1 && dt){
    ...
    if(diff < 0){
      ...
      localStorage.setItem(JSON.stringify({day: 1, datetime: null}))
    }
  }
}
